...
from contracts.protocol.libraries.helpers.constants import P, signed_MIN

# Max value when felt interpreted as signed integer
const signed_MAX = signed_MIN - 1
# Max value when felt interpreted as unsigned integer
const unsigned_MAX = P - 1

@view
func test_P{range_check_ptr}():
    assert signed_MAX = -signed_MIN
    return ()
end
...
func test_is_le_unsigned{range_check_ptr}():
    ...
    # check boundaries
    let (res_4) = SafeCmp.is_le_unsigned(signed_MAX, signed_MIN)
    assert res_4 = TRUE
    let (res_5) = SafeCmp.is_le_unsigned(0, signed_MIN)
    assert res_5 = TRUE
    let (res_6) = SafeCmp.is_le_unsigned(signed_MIN, unsigned_MAX)
    assert res_6 = TRUE
...
func test_is_lt_unsigned{range_check_ptr}():
    ...
    # check boundaries
    let (res_4) = SafeCmp.is_lt_unsigned(signed_MAX, signed_MIN)
    assert res_4 = TRUE
    let (res_5) = SafeCmp.is_lt_unsigned(0, signed_MIN)
    assert res_5 = TRUE
    let (res_6) = SafeCmp.is_lt_unsigned(signed_MIN, unsigned_MAX)
    assert res_6 = TRUE
...
func test_assert_le_unsigned_1{range_check_ptr}():
    %{ expect_revert() %}
    SafeCmp.assert_le_unsigned(unsigned_MAX, signed_MIN)
    return ()
end
...
func test_assert_le_unsigned_2{range_check_ptr}():
    %{ expect_revert() %}
    SafeCmp.assert_le_unsigned(signed_MIN, 0)
    return ()
end

@view
func test_assert_le_unsigned_3{range_check_ptr}():
    SafeCmp.assert_le_unsigned(signed_MIN, signed_MIN)
    SafeCmp.assert_le_unsigned(signed_MIN, unsigned_MAX)
    return ()
end
...
func test_assert_lt_unsigned_1{range_check_ptr}():
    %{ expect_revert() %}
    SafeCmp.assert_lt_unsigned(unsigned_MAX, signed_MIN)
    return ()
end
...
func test_assert_lt_unsigned_2{range_check_ptr}():
    %{ expect_revert() %}
    SafeCmp.assert_lt_unsigned(signed_MIN, 0)
    return ()
end
...
func test_assert_lt_unsigned_3{range_check_ptr}():
    %{ expect_revert() %}
    SafeCmp.assert_lt_unsigned(signed_MIN, signed_MIN)
    return ()
end

@view
func test_assert_lt_unsigned_4{range_check_ptr}():
    SafeCmp.assert_lt_unsigned(signed_MIN, unsigned_MAX)
...
func test_assert_in_range_unsigned_1{range_check_ptr}():
    %{ expect_revert(error_message="Range definition error: low >= high") %}
    SafeCmp.assert_in_range_unsigned(signed_MIN, unsigned_MAX, signed_MIN)
    return ()
end
...
func test_assert_in_range_unsigned_2{range_check_ptr}():
    %{ expect_revert() %}
    SafeCmp.assert_in_range_unsigned(unsigned_MAX, 0, signed_MIN)
    return ()
end
...
func test_assert_in_range_unsigned_3{range_check_ptr}():
    %{ expect_revert() %}
    SafeCmp.assert_in_range_unsigned(signed_MIN, 0, signed_MIN)
    return ()
end

@view
func test_assert_in_range_unsigned_4{range_check_ptr}():
    SafeCmp.assert_in_range_unsigned(signed_MIN, signed_MIN, unsigned_MAX)
    SafeCmp.assert_in_range_unsigned(signed_MIN, 0, unsigned_MAX)
...
func test_is_nn_signed{range_check_ptr}():
    # False results
    let (res_1) = SafeCmp.is_nn_signed(signed_MIN)
    assert res_1 = FALSE
...
func test_is_le_signed{range_check_ptr}():
    ...
    assert res_2 = TRUE
    let (res_3) = SafeCmp.is_le_signed(signed_MIN, signed_MIN)
    assert res_3 = TRUE

    # tests when a is non negative and b neg (always FALSE)
    let (res_4) = SafeCmp.is_le_signed(3, -1)
    assert res_4 = FALSE
    let (res_5) = SafeCmp.is_le_signed(1, signed_MIN)
    assert res_5 = FALSE

    # tests when a is neg and b non neg (always TRUE)
    let (res_6) = SafeCmp.is_le_signed(signed_MIN, 2)
    assert res_6 = TRUE
    let (res_7) = SafeCmp.is_le_signed(-1, 5)
    assert res_7 = TRUE

    # tests when a and b are the same sign
    let (res_8) = SafeCmp.is_le_signed(P + 1, signed_MAX)
    assert res_8 = TRUE
    let (res_9) = SafeCmp.is_le_signed(3, 2)
    assert res_9 = FALSE
    let (res_10) = SafeCmp.is_le_signed(signed_MAX, P + 1)
    assert res_10 = FALSE
    let (res_11) = SafeCmp.is_le_signed(unsigned_MAX, signed_MIN)
    assert res_11 = FALSE
    let (res_12) = SafeCmp.is_le_signed(signed_MIN, unsigned_MAX)
    assert res_12 = TRUE
...
func test_is_lt_signed{range_check_ptr}():
    ...
    assert res_2 = FALSE
    let (res_3) = SafeCmp.is_lt_signed(signed_MIN, signed_MIN)
    assert res_3 = FALSE

    # tests when a is non negative and b neg (always FALSE)
    let (res_4) = SafeCmp.is_lt_signed(3, -1)
    assert res_4 = FALSE
    let (res_5) = SafeCmp.is_lt_signed(1, signed_MIN)
    assert res_5 = FALSE

    # tests when a is neg and b non neg (always TRUE)
    let (res_6) = SafeCmp.is_lt_signed(signed_MIN, 2)
    assert res_6 = TRUE
    let (res_7) = SafeCmp.is_lt_signed(-1, 5)
    assert res_7 = TRUE

    # tests when a and b are the same sign
    let (res_8) = SafeCmp.is_lt_signed(P + 1, signed_MAX)
    assert res_8 = TRUE
    let (res_9) = SafeCmp.is_lt_signed(3, 2)
    assert res_9 = FALSE
    let (res_10) = SafeCmp.is_lt_signed(signed_MAX, P + 1)
    assert res_10 = FALSE
    let (res_11) = SafeCmp.is_lt_signed(unsigned_MAX, signed_MIN)
    assert res_11 = FALSE
    let (res_12) = SafeCmp.is_lt_signed(signed_MIN, unsigned_MAX)
    assert res_12 = TRUE
...
func test_is_in_range_signed_3{range_check_ptr}():
    ...
    assert P = 0
    let (res_2) = SafeCmp.is_in_range_signed(P, 0, signed_MAX)
    assert res_2 = TRUE
    ...
    let (res_6) = SafeCmp.is_in_range_signed(unsigned_MAX, P - 2, 1)
    assert res_6 = TRUE
    ...
    let (res_9) = SafeCmp.is_in_range_signed(-2, signed_MIN, unsigned_MAX)
    assert res_9 = TRUE
    let (res_10) = SafeCmp.is_in_range_signed(1, P, signed_MAX)
    assert res_10 = TRUE
    let (res_11) = SafeCmp.is_in_range_signed(P, 1, signed_MAX)
    assert res_11 = FALSE
    let (res_12) = SafeCmp.is_in_range_signed(unsigned_MAX, signed_MIN, -2)
    assert res_12 = FALSE
...
func test_assert_nn_signed_2{range_check_ptr}():
    %{ expect_revert() %}
    SafeCmp.assert_nn_signed(signed_MIN)
    return ()
end
...
func test_assert_le_signed_1{range_check_ptr}():
    ...
    SafeCmp.assert_le_signed(-1, -1)
    SafeCmp.assert_le_signed(P, 0)

    # tests when a is neg and b non neg (always TRUE)
    SafeCmp.assert_le_signed(signed_MIN, 2)
    SafeCmp.assert_le_signed(-1, 5)

    # tests when a and b are the same sign
    SafeCmp.assert_le_signed(P + 1, signed_MAX)
    SafeCmp.assert_le_signed(signed_MIN, unsigned_MAX)
    return ()
end
...
func test_assert_le_signed_3{range_check_ptr}():
    # tests when a is non negative and b neg (reverts)
    %{ expect_revert() %}
    SafeCmp.assert_le_signed(1, signed_MIN)
    return ()
end
...
func test_assert_lt_signed_2{range_check_ptr}():
    # tests when a = b : expects revert
    %{ expect_revert() %}
    SafeCmp.assert_lt_signed(P, 0)
    return ()
end

func test_assert_lt_signed_3{range_check_ptr}():
    # tests when a is neg and b non neg (always TRUE)
    SafeCmp.assert_lt_signed(signed_MIN, 2)
    SafeCmp.assert_lt_signed(-1, 5)

    # tests when a and b are the same sign
    SafeCmp.assert_lt_signed(P + 1, signed_MAX)
    SafeCmp.assert_lt_signed(signed_MIN, unsigned_MAX)
    return ()
end
...
func test_assert_lt_signed_5{range_check_ptr}():
    # tests when a is non negative and b neg (reverts)
    %{ expect_revert() %}
    SafeCmp.assert_lt_signed(1, signed_MIN)
    return ()
end
...
func test_assert_in_range_signed_1{range_check_ptr}():
    ...
    %{ expect_revert() %}
    SafeCmp.assert_in_range_signed(1, unsigned_MAX, signed_MIN)
    return ()
end
...
func test_assert_in_range_signed_3{range_check_ptr}():
    ...
    SafeCmp.assert_in_range_signed(P + 1, P + 1, signed_MAX)
    ...
    # tests when  low and value are neg, high is positive
    SafeCmp.assert_in_range_signed(unsigned_MAX, P - 2, 1)
    SafeCmp.assert_in_range_signed(-1, -1, 2)

    # tests when  low and high are same sign
    SafeCmp.assert_in_range_signed(-2, signed_MIN, unsigned_MAX)
    SafeCmp.assert_in_range_signed(1, P, signed_MAX)
...
func test_assert_in_range_signed_6{range_check_ptr}():
    ...
    %{ expect_revert() %}
    SafeCmp.assert_in_range_signed(P, 1, signed_MAX)
    return ()
end
...
func test_assert_in_range_signed_7{range_check_ptr}():
    # reverts when low and high are same sign
    %{ expect_revert() %}
    SafeCmp.assert_in_range_signed(unsigned_MAX, signed_MIN, -2)
    return ()
end
