...
namespace SafeFeltMath {
    ...
    func add_unsigned{range_check_ptr}(a: felt, b: felt) -> felt {
        alloc_locals;
    ...
    func sub_le_unsigned{range_check_ptr}(a: felt, b: felt) -> felt {
        alloc_locals;
    ...
    func mul_unsigned{range_check_ptr}(a: felt, b: felt) -> felt {
        alloc_locals;
    ...
    func pow_unsigned{range_check_ptr}(base: felt, power: felt) -> felt {
        alloc_locals;
    ...
    func add_mul_unsigned{range_check_ptr}(a: felt, b: felt, c: felt) -> felt {
        alloc_locals;
    ...
    // @param b Unsigned felt integer
    // @returns res Result of (a * b) + c
    func mul_add_unsigned{range_check_ptr}(a: felt, b: felt, c: felt) -> felt {
        alloc_locals;
    ...
    // @returns res Sum of a and b
    func add_signed{range_check_ptr}(a: felt, b: felt) -> felt {
        alloc_locals;
    ...
    // @param b Signed felt integer
    // @returns res Difference between a and b
    func sub_signed{range_check_ptr}(a: felt, b: felt) -> felt {
        alloc_locals;
