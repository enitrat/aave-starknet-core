...
namespace StableDebtToken:
    ...
    func mint{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        let (_, local current_balance, balance_increase) = _calculate_balance_increase(on_behalf_of)
    ...
    func burn{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        alloc_locals
        IncentivizedERC20.assert_only_pool()
        let (_, local current_balance, balance_increase) = _calculate_balance_increase(address_from)
        let (previous_supply) = total_supply()
...
func _calculate_balance_increase{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    previous_principal_balance : Uint256,
    new_principal_balance : Uint256,
    balance_increase : Uint256,
):
    alloc_locals
...
func _calc_and_update_next_values{
    syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr
